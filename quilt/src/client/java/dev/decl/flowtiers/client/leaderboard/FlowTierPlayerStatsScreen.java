...
public final class FlowTierPlayerStatsScreen extends Screen {
    ...
    private void renderGraph(DrawContext ctx, FlowTierStats stats,
        ...
        int tierRaw = ladder != null ? dev.decl.flowtiers.client.FlowTierRankSystem.tierColor(ladder.tierLabel(), ladder.position()) : 0x3B82F6;
    ...
    private static int tierColor(String tier, int pos) {
        int c = dev.decl.flowtiers.client.FlowTierRankSystem.tierColor(tier, pos);
