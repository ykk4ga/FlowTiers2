...
public final class RankedMatchDetector {
    ...
    public static boolean isInRankedMatch() {
        ...
        dev.fecl.flowtiers.FlowTiers.LOGGER.info("[RankedDetector] result={}", result);
        cachedResult = result;
        cachedAt = now;
        return result;
    }
    ...
    private static boolean detect() {
        ...
        try {
            ...
            if (sb != null) {
                ...
                if (sidebar != null) {
                    ...
                    dev.fecl.flowtiers.FlowTiers.LOGGER.info("[RankedDetector] sidebar: '{}'", title);
                    if (isRankedKeyword(title)) return true;
                }
                ScoreboardObjective list = getObjectiveForSlot(sb, 0, "LIST");
                dev.fecl.flowtiers.FlowTiers.LOGGER.info("[RankedDetector] LIST slot: {}", list != null ? list.getName() : "null");
        ...
        try {
            ...
            if (hud != null && hud.getPlayerListHud() != null) {
                ...
                if (header != null) dev.fecl.flowtiers.FlowTiers.LOGGER.info("[RankedDetector] header: '{}'", header.getString());
            ...
            if (net != null) {
                ...
                for (PlayerListEntry e : net.getPlayerList()) {
                    ...
                    if (disp != null) {
                        ...
                        dev.fecl.flowtiers.FlowTiers.LOGGER.info("[RankedDetector] tab: '{}'", stripped);
